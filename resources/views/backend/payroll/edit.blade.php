                            ...
                            <form action="{{route('pay.update', $pay->id )}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control" type="hidden" name="employee_id" value="{{$pay->employee_id}}" readonly>
                                        <div class="form-group">
                                            <label>Basic Salary</label>
                                            <input type="text" class="form-control" name="basic" value="{{$pay->basic}}" required placeholder="Type something" />
                                        </div>
                                        <div class="form-group">
